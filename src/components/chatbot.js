        ...
        "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyBPk4NYw_5enfX5-OJxYN14haaxFoQxiPM",
        {
          ...
          body: JSON.stringify({
            contents: [
              {
                parts: [{ 
                  text: `Respond to the user query: ${val}\n\nDo NOT use markdown format! Respond from the point of view of a chill and professional co-worker. Each response should be no more than 2 sentences each. Only respond in plain text with NO formatting. Respond in short, readable messages as if you're texting with a friend and giving advice. The user is working on unprocessed pallet survey for their job. This survey requires entries for remaining pallets, cartons processed, CPH, ZPH, and pallets delivered. The specialized calculator they are using will do the calculations for them as long as they have data for carried-over pallets, remaining pallets, pallets delivered, hours hanging, z-racks filled, and total backroom hours. The user might also wants to chat about general practices for running a backroom at a retail store.` 
                }]
              }
            ]
          })
